...
while numero_rodadas <= 4:
    ...
    try:
        ...
        if caracteristica not in [1, 2, 3]:
            print(Fore.RED + "Digite um numero válido!")
            sleep(3)
            os.system('cls')
            ...
            # Resumo da rodada
            sleep(3)
            print(Fore.YELLOW + "⎯" * 24 + f"Resumo da {numero_rodadas}ª "
                  "rodada" + "⎯" * 26)
            ...
            if pick_jogador1[caracteristica] == pick_jogador2[caracteristica]:
                ...
                # Insere em cima da pilha do 1º jogador uma carta vinda da
                # pilha central
                ...
                # Insere em cima da pilha do 2º jogador uma carta vinda da
                # pilha central
                ...
                # Adiciona os pts
                pontos_jogador1 += pick_jogador1[caracteristica]
                ...
                print(Fore.GREEN +
                      f"{nome1} ganhou {pontos_ganhos} pontos!", "🤑")
                print(
                    Fore.RED + f"{nome2} perdeu {pontos_perdidos} pontos! 💀")
                ...
                # Adiciona os pts
                pontos_jogador2 += pick_jogador2[caracteristica]
                ...
                print(Fore.GREEN +
                      f"{nome2} ganhou {pontos_ganhos} pontos!", "🤑")
                print(
                    Fore.RED + f"{nome1} perdeu {pontos_perdidos} pontos! 💀")
            ...
            # Em caso de sucessivos empates, e a pilha central ficar vazia,
            # então a pilha central receberá a pilha de descarte com todos os
            # descartes anteriores das rodadas em que houve empate
            if pilha_central == []:
        ...
        print(Fore.RED + "Por favor, digite um número inteiro.")
        sleep(3)
        os.system('cls')
